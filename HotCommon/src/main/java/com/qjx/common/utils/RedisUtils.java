 ...
 * @author: quanjx
 * @create: 2019-12-17 10:21
 **/
public class RedisUtils {
    private JedisPool pool = null;
    private RedisUtils(String ip,int port,String password,int maxTotal,int maxIdle,int maxWaitMillis,boolean testOnBorrow) {
        if (pool == null) {
    ...
    public static RedisUtils getRedisUtil(String ip,int port,String password,int maxTotal,int maxIdle,int maxWaitMillis,boolean testOnBorrow) {
        return new RedisUtils(ip,port,password,maxTotal,maxIdle,maxWaitMillis,testOnBorrow);
    }
}
